...
function getuseravatar($addedby){
    ...
    $link=sefRelToAbs("index.php?option=com_mytube&task=uservideoslist&Itemid=$Itemid&from=0&userid=$addedby");
    ...
    if ($avatar==""){
        $avatar="<a href=\"".$link."\"><img src=\"".$mosConfig_live_site."/components/com_mytube/themes/".$theme."/images/noavatar.jpg\" border=\"0\" width=\"48\"></a>";
    }
...
function jagetusersname($id) {
    ...
    require($mosConfig_absolute_path."/administrator/components/com_mytube/mytube_config.php");
...
function getmytubecomments($id){
    global $mosConfig_absolute_path, $Itemid;
    require($mosConfig_absolute_path.'/components/com_mytube/includes/mytube_permissions.php');
    require($mosConfig_absolute_path."/administrator/components/com_mytube/mytube_config.php");
    ...
    if ($showcomments=="yes"){
        ...
        if ($commentingsystem=="jcomments") {
            ...
            if (file_exists( $comments )) {
                ...
                $comments = JComments::showComments( $id, 'com_mytube', '' );
            }
            ...
            if (file_exists($jomcommentfile)){
                ...
                $comments=jomcomment($id, "com_mytube");
                $comments.="<div id=\"mytubefbdiscussinput\"></div><div id=\"toggle\"></div>";
            }
        } else if ($commentingsystem=="fireboard") {

            if ($showcomments=="yes"){
                $comments=mytubefbforum($id);
            }
