...
<fieldset class="adminform">
	...
	<tbody>
	   <tr>
	       ...
	       <td>
	           <?php echo JHTML::_('select.genericlist', $this->uploader_type, 'uploader_type', 'disabled=\'true\'', 'value', 'text', $this->c->uploader_type); ?>
	       </td>
	   </tr>
	   ...
	   <tr>
	       ...
	       <td>
	           ...
	           <input type="text" name="filesize" value="<?php echo $upload_max?>" disabled="true" /> <span class="mytube_warning">(Depend on your PHP config )</span>
	       </td>
	   </tr>
...
<fieldset class="adminform">
	...
	<tbody>
	   <tr>
	       ...
	       <td>
	           <?php echo JHTML::_('select.genericlist', $this->yesno, 'auto_approve', 'disabled=\'true\'', 'value', 'text', $this->c->auto_approve); ?>
	       </td>
	   </tr>
	</tbody>
    </table>
