...
class mytubeControllerPlugins extends mytubeController
{
    ...
    function doInstall()
    {
        ...
        $this->setRedirect('index.php?option=com_mytube&view=plugins');
    }
        ...
        if ($returnid = $model->store($post)) {
            ...
            switch ($task)
            {
                case 'apply':
                    ...
                    $this->setRedirect( 'index.php?option=com_mytube&view=plugin&id='. $returnid, $msg );
                    break;

                case 'save':
                default:
                    $msg = JText::sprintf( 'Successfully Saved Plugin');
                    $this->setRedirect( 'index.php?option=com_mytube&view=plugins', $msg );
                    break;
            }
