 ...
 * @since 0.9
 */
class mytubeControllerVideos extends mytubeController
{
	/**
	 * Constructor
	 *
	...
	function uploadbatch() {
	  ...
	  $this->setRedirect('index.php?option=com_mytube&view=videos', 'Upload Batch Success: ' . $counter . ' videos !');
	}
	/**
	...
	function save()
	{
		...
		if ($returnid = $model->store($post)) {
			...
			{
				case 'apply' :
					$link = 'index.php?option=com_mytube&view=video&cid[]='.$returnid;
					break;

				default :
					$link = 'index.php?option=com_mytube&view=videos';
					break;
			}
			...
			$msg 	= '';
			$link 	= 'index.php?option=com_mytube&view=video';
		}
	...
	function publish()
	{
		...
		$this->setRedirect( 'index.php?option=com_mytube&view=videos', $msg );
	}
	...
	function featured() {
	  ...
	  $this->setRedirect('index.php?option=com_mytube&view=videos');
	}
...
//		JRequest::checkToken() or die( 'Invalid Token' );
//
//		$video = & JTable::getInstance('mytube_videos', '');
//		var_dump($video);
