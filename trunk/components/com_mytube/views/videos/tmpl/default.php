...
<div id="videomainbody">
	...
	<!--############ VIDEO LEFT COLUMN ###########-->
    <?php JTHelper::loadCustomVerticalModule('mytube_vidlist_left', $this->c->width_mytube_left_module, 'left')?>

    <!--############ VIDEO GRID MIDDLE COLUMN ###########-->

	<div id="videomiddle-column" style="width:<?php echo $this->c->width_mytube_center_module?>px">
		<div id="browseMain">

			<form action="<?php echo JRoute::_( 'index.php' );?>" method="get" name="mytubeForm" id="mytubeForm" >
			...
			<!--###################################################-->
				  ...
				  <?php if ($category_id != ''):?>
				   <div style="padding-top: 10px;">
				    <a href="index.php?option=com_mytube&view=videos">Main</a>
						...
						<div class="video-cell" style="width:<?php echo $this->c->columns_per_page?>%">
							<div class="video-entry">
								...
								<div class="video-facets">
			        					...
			        					<div>
			            						<?php echo _VIDEOINFO_AUTHOR ?>:<span class="video-username"> <a href="<?php echo JRoute::_("index.php?view=videos&type=member&user_id=" . $item->user_id) ?>"><?php echo mytube::showShortAuthor($item->username)?></a></span>
			        					</div>
			        					...
			        					<div class="video-thumb-duration-rating">
			        					 <div style="float:left">
			          						<?php
			          						$emptyStar = JURI::base() . "components/com_mytube/assets/images/emptyStar12x12.gif";
			          						$halfStar = JURI::base() . "components/com_mytube/assets/images/halfStar12x12.gif";
			          						$fullStar = JURI::base() . "components/com_mytube/assets/images/fullStar12x12.gif";
			          						if ($item->ratingAvg > 0) {
	...
	<!--############ VIDEO RIGHT COLUMN ###########-->
	<?php JTHelper::loadCustomVerticalModule('mytube_vidlist_right', $this->c->width_mytube_right_module, 'right')?>
</div>