...
<!--############ LEFT COLUMN ###########-->
    <?php JTHelper::loadCustomVerticalModule('mytube_category_left', $this->c->category_column_left_width, 'left')?>
...
<!--############ RIGHT COLUMN ###########-->
    <?php JTHelper::loadCustomVerticalModule('mytube_category_right', $this->c->category_column_right_width, 'right')?>
