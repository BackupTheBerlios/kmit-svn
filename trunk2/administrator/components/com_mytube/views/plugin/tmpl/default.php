...
<div class="col width-60">
	...
	<table class="admintable">
		...
		<tr>
			...
			<td>
				<input disabled="disabled" class="text_area" type="text" name="element_disable" id="element_disable" size="35" value="<?php echo $this->plugin->element; ?>" />.php
				<input type="hidden" name="element" value="<?php echo $this->plugin->element; ?>" />
			</td>
		</tr>
		<tr>
			<td valign="top" class="key">
				<label for="element">
					<?php echo JText::_( 'Plugin folder' ); ?>:
				</label>
			</td>
			<td>
...
<div class="clr"></div>
	<input type="hidden" name="option" value="com_mytube" /><br>
