            ...
            <td>
                <table width="100%">
                	...
                	<tr>
                		...
                		<td>
                			<input class="input_box" id="install_package" name="install_package" type="file" size="57" disabled="true" />
                			<input class="button" type="button" value="<?php echo JText::_( 'Upload File' ); ?> &amp; <?php echo JText::_( 'Install' ); ?>" onclick="submitbutton1()" disabled="true" />
                		</td>
                	</tr>
            	</table>
            </td>
