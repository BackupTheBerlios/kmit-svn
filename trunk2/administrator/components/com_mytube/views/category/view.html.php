...
class mytubeViewCategory extends JView {
	...
	function display($tpl = null)
	{
		...
		//create the toolbar
		if ( $cid ) {
			JToolBarHelper::title( JText::_( 'EDIT CATEGORY' ), 'mytube-categories' );

		} else {
			JToolBarHelper::title( JText::_( 'ADD CATEGORY' ), 'mytube-categories' );
