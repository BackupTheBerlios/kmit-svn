...
<fieldset class="adminform">
    <legend><?php echo JText::_('Import Videos from Seyret');?> <span class="mytube_warning">(Only support remote video)</span></legend>
    <table class="admintable" cellspacing="1">
        <col width="250"></col>
	<tbody>
	   <?php if ($this->seyret_check):?>
                <tr>
                    <td class="key">Import from Seyret category</td>
                    <td><?php echo $this->seyretcatsel; ?></td>
                </tr>
                <tr>
            ...
            <?php else: ?>
                <span class="mytube_warning"><?php echo JText::_("Seyret component is not yet installed on this Joomla website");?></span>
            <?php endif;?>
	</tbody>
    </table>
</fieldset>
