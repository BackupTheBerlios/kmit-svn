...
<fieldset class="adminform">
	...
	<tbody>
	   <tr>
	       ...
	       <td>
	           <a href="http://www.mytube.com/dokuwiki/doku.php?id=margin.left.side.of.page" title="Click Here For Help" target="_blank"><img src="<?php echo JURI::base()?>components/com_mytube/assets/images/question.png" alt="Click Here For Help"></a>
	       </td>
	   </tr>
	   <tr>
