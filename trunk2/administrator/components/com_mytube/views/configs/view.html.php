...
class mytubeViewConfigs extends JView {
    ...
    function display($tpl = null)
    {
        ...
        //create the toolbar
        if ( $cid ) {
            JToolBarHelper::title( JText::_( 'CONFIGURATON' ), 'mytube-videos' );
        } else {
            JToolBarHelper::title( JText::_( 'CONFIGURATION' ), 'mytube-videos' );
        }
        ...
        $styles_file = JPATH_SITE . DS . DS . 'components' . DS . 'com_mytube' . DS . 'assets' . DS . 'styles' . DS . 'styles.ini';
        ...
        $languages_file = JPATH_SITE . DS . DS . 'components' . DS . 'com_mytube' . DS . 'languages' . DS . 'languages.ini';
