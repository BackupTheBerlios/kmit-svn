 ...
 * @since 0.9
 */
class mytubeControllerConfigs extends mytubeController
{
    /**
	 * Constructor
	 *
    ...
    function save()
    {
        ...
        if (!$permission) {
            ...
            $link = JRoute::_('index.php?option=com_mytube&view=configs');
        ...
        $config .= "    var \$width_mytube_left_module = '" . $c["width_mytube_left_module"] . "'; \n ";
        $config .= "    var \$width_mytube_right_module = '" . $c["width_mytube_right_module"] . "'; \n ";
        $config .= "    var \$width_mytube_center_module = '" . $c["width_mytube_center_module"] . "'; \n\n ";
        ...
        $msg = JText::_('SAVED');
        $link = 'index.php?option=com_mytube&view=configs';
        $this->setRedirect($link, $msg);
    }
}