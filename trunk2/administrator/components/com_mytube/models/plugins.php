...
require_once (JPATH_ADMINISTRATOR.DS.'components'.DS.'com_mytube'.DS.'helpers'.DS.'JomTubeInstaller.php');

class mytubeModelPlugins  extends JModel
{
    /**
	 * Category data array
	 *
    ...
    function store($data)
    {
        $row  =& $this->getTable('mytube_plugins', '');
        //var_dump($data); exit();
