...
<!--############ VIDEO LEFT COLUMN ###########-->
    <?php JTHelper::loadCustomVerticalModule('mytube_addvideo_left', $this->c->addvideo_column_left_width, 'left')?>

<!--############ MIDDLE COLUMN ###########-->
	<div id="videomiddle-column" style="width:<?php echo $this->c->addvideo_column_center_width?>px">
		<div id="mytube-addvideo-container">
		        ...
		        <?php if ($this->existed_video): //video existed?>
		            <tr>
		                <td valign="middle" align="center" height="100">
		                    ...
		                    <br/>
		                    <b><a href="index.php?option=com_mytube&view=video&id=<?php echo $this->existed_video->id ?>">View this video</a> | <a href="index.php?option=com_mytube&view=addvideo">Add other video</a></b>
		                </td>
		            </tr>
		        <?php else:?>
		     		<tr>
...
<!--############ RIGHT COLUMN ###########-->
    <?php JTHelper::loadCustomVerticalModule('mytube_addvideo_right', $this->c->addvideo_column_right_width, 'right')?>
