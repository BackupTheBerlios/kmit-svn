...
<!--############ MIDDLE COLUMN ###########-->
  	<div id="videomiddle-column" style="width:<?php echo $this->c->addvideo_column_center_width?>px">
	    ...
	    <div>
	          <?php
	          $mytube_addvideo_disclaimer_modules = &JModuleHelper::getModules('addvideo_disclaimer');
	          foreach ($mytube_addvideo_disclaimer_modules as $addvideo_disclaimer_module) {
