...
class mytubeViewVideo extends JView {
    ...
    function display($tpl = null)
    {
        ...
        $this->assignRef( 'mytubeComments', toolsHelpers::integrateVideoComments($row));
        /*if ($c->commenting_system == "JomComment") {
            if (file_exists(JPATH_ROOT.DS.'plugins'.DS.'content'.DS.'jom_comment_bot.php')) {
                ...
                $this->assignRef( 'mytubeComments', new JVComments());
            } else {
                $warningMsg = 'notinstall';
                $this->assignRef( 'mytubeComments', $warningMsg);
            }
        }*/
